...
The tests are measued using various allocation sizes.
...
\begin{figure}[tbh!]
  \centering
  \includegraphics[width=\columnwidth]{graphs/light_hist1.png}
...
\begin{figure}[tbh!]
  ...
  \caption{ Performance differences in libc.so.6 between allocation methods at various sizes (Nano Seconds) }
  \label{algo1_libc.so.6_bar}
\end{figure} 

\begin{figure}[tbh!]
  \centering
  \includegraphics[width=\columnwidth]{graphs/light_stack_malloc_hist1.png}
  \caption{ Comparison of allocation methods in nano seconds }
...
\begin{figure}[tbh!]
  \centering
  \includegraphics[width=\columnwidth]{graphs/light_init_calloc_hist1.png}
  \caption{ Comparison of allocation methods in nano seconds }
