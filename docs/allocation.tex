...
The set of allocators include glibc, ptmalloc, jemalloc, tcmalloc, and hoard.
...
In order to obtain a baseline benchmark of allocation times, Algorithm \ref{light_usage_algorithm} is used with various sizes of $S$.
