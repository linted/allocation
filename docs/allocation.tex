...
Looking specifically at stack and malloc allocaiton in Fig. \ref{algo3_stack_malloc_hist}, there is minimal difference between the two within the allocation sizes.
Similarly initalized stack and calloc have network through puts across the allocation sizes in Fig. \ref{algo3_init_calloc_hist}.
...
Finally when allocaiton latency is vastly outweighed by IO operations and syscalls.
